...
return l.formatDate&&(r=e("date")(1e3*r,l.formatDate,"+0000")),l.onRender=l.onRender||function(a){return a},l.onRender(r)},t.statsParse=function(){var a="Showing %1 to %2 of %3 results",e=(t.pages.current-1)*t.pages.max>0?(t.pages.current-1)*t.pages.max+1:t._data.length>0?1:0
