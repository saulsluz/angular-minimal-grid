...
for(var e=Math.ceil(a/n.pages.max),t=1;t<=e;t++)n.pages.total.push(t)}function l(){n.pages.current>n.pages.total.length&&(n.pages.current=1,n._lastPagePaginate=1),n.pages.first=1,n.pages.last=n.pages.total.length,n.pages.previous=n.pages.current-1>0?n.pages.current-1:1,n.pages.next=n.pages.current+1<=n.pages.total.length?n.pages.current+1:n.pages.total.length,n.pages.pagination=i()}function i(){var a=0
a<n.pages.range&&(a=n.pages.current-Math.ceil(n.pages.range/2))
var e=n.pages.total.length-n.pages.range
